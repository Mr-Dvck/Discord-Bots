...
const DEFAULT_MODULES: ModuleConfig[] = [
  {
    id: "memory",
    name: "Memory System",
    description: "Message monitoring, user profiling, personality analysis — /profile /remember /servermap",
    icon: "🧠",
    enabled: true,
    category: "Core",
  ...
  },
  {
    ...
    enabled: true,
    category: "Engagement",
    settings: { daily_min: 80, daily_max: 150, work_max_per_day: 10 },
  },
  {
    id: "giveaways",
    name: "Giveaways",
  ...
  },
  {
    id: "reminders",
    name: "Reminders",
    description: "/misc remindme — personal timed reminders",
    icon: "⏰",
    enabled: true,
    category: "Utility",
  ...
  },
  {
    id: "starboard",
    name: "Starboard",
    description: "/mod star + star-reaction board (threshold configurable)",
    icon: "⭐",
    enabled: false,
    category: "Engagement",
